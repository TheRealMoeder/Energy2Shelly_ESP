...
if(cfg.modbusDevice)document.querySelector('[name=modbusDevice]').value=cfg.modbusDevice;
if(cfg.powerPath!==undefined)document.querySelector('[name=powerPath]').value=cfg.powerPath;
if(cfg.pwrExportPath!==undefined)document.querySelector('[name=pwrExportPath]').value=cfg.pwrExportPath;
if(cfg.powerL1Path!==undefined)document.querySelector('[name=powerL1Path]').value=cfg.powerL1Path;
if(cfg.powerL2Path!==undefined)document.querySelector('[name=powerL2Path]').value=cfg.powerL2Path;
